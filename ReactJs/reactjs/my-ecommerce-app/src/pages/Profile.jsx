...
function Profile() {
  ...
  const tabs = [
    ...
    { id: 'history', label: 'История отправлений', icon: 'M13.5 3H12v-3h-2v3H7.5v3H13.5V3zm-5 2H3v1h5V5zm5 7h-3v3h-2v-3H7.5v-3h6v3zM19 21H5c-1.1 0-2-.9-2-2V5c0-1.1.9-2 2-2h14c1.1 0 2 .9 2 2v14c0 1.1-.9 2-2 2z' },
    ...
    { id: 'loyalty', label: 'Система лояльности', icon: 'M12 2a10 10 0 0 0-10 10c0 5.52 4.48 10 10 10s10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-11h2v2h-2zm0 4h2v6h-2z' },
  ];
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="w-full lg:w-3/4">
            {activeTab === 'personal-data' && (
              <PersonalDataTab setError={setError} />
            )}
            {activeTab === 'shipments' && (
              <ShipmentsTab currentOrders={currentOrders} handleViewOrderDetails={handleViewOrderDetails} handlePay={handlePay} />
            )}
            {activeTab === 'history' && (
              <OrderHistoryTab orderHistory={orderHistory} handleViewOrderDetails={handleViewOrderDetails} />
            )}
